...
export const CAMPAIGN_ENTITIES: CampaignEntity[] = [
  ...
  person("Hugo Chávez", "hugo-chavez"),
  ...
  person("Lauchlin Currie", "lauchlin-currie"),
  person("Benjamín Herrera", "benjamin-herrera"),
  person("Raúl Reyes", "raul-reyes"),
  person("Carlos Rosero", "carlos-rosero"),
  person("Rafael Pardo", "rafael-pardo"),
  person("Juan de la Cruz Varela", "juan-de-la-cruz-varela"),
  person("Ingrid Betancourt", "ingrid-betancourt"),
  person("Horacio Serpa", "horacio-serpa"),
  person("Edwin Kemmerer", "edwin-kemmerer"),

  // Lugares — ciudades, regiones, ríos y escenarios históricos inequívocos.
  place("Zipaquirá", "zipaquira", "villa andina, centro salinero y escenario comunero"),
  place("Chicoral", "chicoral", "corregimiento tolimense y escenario del pacto agrario de 1972"),
  place("Altiplano cundiboyacense", "altiplano-cundiboyacense", "región histórica muisca y eje agrario andino"),
  place("Ocaña", "ocana", "ciudad nororiental y escenario de la Convención de 1828"),
  place("San Basilio de Palenque", "san-basilio-de-palenque", "territorio cimarrón y comunidad afrodescendiente histórica"),
  ...
  place("Plaza de Bolívar", "plaza-de-bolivar", "centro cívico de Bogotá y escenario de poder y movilización"),
  ...
  concept("Impunidad estructural", "impunidad-estructural"),
