...
export const CAMPAIGN_ENTITIES: CampaignEntity[] = [
  ...
  person("Miguel Samper", "miguel-samper"),
  person("Tomás Carrasquilla", "tomas-carrasquilla"),
  person("José Eustasio Rivera", "jose-eustasio-rivera"),
  person("Ignacio Torres Giraldo", "ignacio-torres-giraldo"),
  person("Raúl Eduardo Mahecha", "raul-eduardo-mahecha"),
  ...
  person("Esmeralda Arboleda", "esmeralda-arboleda"),
  ...
  person("Libia Grueso", "libia-grueso"),
  person("Aida Quilcué", "aida-quilcue"),
  person("Carlos Rosero", "carlos-rosero"),
  person("Humberto de la Calle", "humberto-de-la-calle"),
  person("Antanas Mockus", "antanas-mockus"),
  person("Ingrid Betancourt", "ingrid-betancourt"),
  person("Horacio Serpa", "horacio-serpa"),
  person("Ofelia Uribe de Acosta", "ofelia-uribe-de-acosta"),
