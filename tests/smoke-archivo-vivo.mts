...
const ROUTES: RouteCheck[] = [
  ...
  { path: "/admin/chat", label: "Chat", contains: "Consultar" },
  { path: "/admin/timeline", label: "Timeline", contains: "Quinientos años" },
  { path: "/admin/documents", label: "Documents", contains: "Documentos" },
  { path: "/admin/upload", label: "Upload", contains: "Cargar" },
  { path: "/admin/enrich", label: "Enrich", contains: "Enriquecer" },
  { path: "/admin/questions", label: "Questions", contains: "Preguntas" },
  { path: "/admin/questions/matriz", label: "QuestionsMatriz", contains: "Matriz Q×T" },
  { path: "/admin/questions/generate", label: "QuestionsGenerate", contains: "Generar" },
  ...
  { path: "/admin/producciones", label: "Producciones", contains: "Producciones" },
  { path: "/admin/bibliography", label: "Bibliography", contains: "Bibliografía" },
  { path: "/threads", label: "Threads", contains: "Hilos" },
  { path: "/workspaces", label: "Workspaces", contains: "Workspaces" },
  { path: "/admin/entities", label: "Entities", contains: "Entidades" },
  { path: "/admin/graph", label: "Graph", contains: "Grafo" },
];
